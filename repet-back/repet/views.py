...
class UserView(APIView):
    ...
    def put(self, request, pk):
        if pk:
            ...
            return Response({"detail": "Usuário não especificado"}, status=status.HTTP_400_BAD_REQUEST)
...
class PetView(APIView):
    ...
    def put(self, request, pk=None):
        if pk:
            ...
            return Response({"detail": "Pet não especificado."}, status=status.HTTP_400_BAD_REQUEST)
...
class RecordView(APIView):
    ...
    def put(self, request, pk=None):
        if pk:
            ...
            return Response({"detail": "Registro não especificado."}, status=status.HTTP_400_BAD_REQUEST)
        ...
        if pk:
            ...
            if serializer.is_valid():
                ...
                if vaccine_serializer.is_valid():
                    ...
                    return Response({"detail": "Erro ao atualizar a vacina."}, status=status.HTTP_400_BAD_REQUEST)
            else:
                return Response({"detail": "Erro ao atualizar a vacina."}, status=status.HTTP_400_BAD_REQUEST)
        else:
            return Response({"detail": "Vacina não especificada"}, status=status.HTTP_400_BAD_REQUEST)
...
class RemindersView(APIView):
    ...
    def put(self, request, pk=None):
        if pk:
            ...
            return Response({"detail": "Lembrete não especificado"}, status=status.HTTP_400_BAD_REQUEST)
